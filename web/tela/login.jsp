...
<%
    if (request.getSession().getAttribute("mensagem") != null) {
        String msg = request.getSession().getAttribute("mensagem").toString();
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" id="InputLogin" aria-describedby="loginHelp" name="login"/>
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <input required type="password" class="form-control" id="inputSenha" name="senha"/>
                        </div>
                    </div>
                    <div class="col-5"></div>
                </div>
